...
function(update_version module_version_string)
    ...
    if(EXISTS "${PROJECT_SOURCE_DIR}/.git/HEAD" )
        FILE(STRINGS "${PROJECT_SOURCE_DIR}/.git/HEAD" hash_infos)
        string(SUBSTRING ${hash_infos} 0 5 ref_header)
        if(${ref_header} STREQUAL "ref: ")
            string(SUBSTRING ${hash_infos} 5 -1 ref_path)
            FILE(STRINGS "${PROJECT_SOURCE_DIR}/.git/${ref_path}" hash_parts)
            set(VERSION_HASH ${hash_parts})
        else()
            set(VERSION_HASH ${hash_infos})
        endif()
    endif()
