...
ResolvedTypeReference TS_TypeResolver::resolveType(const TypeReference &ref) {
...
ResolvedTypeReference TS_TypeMapper::getGodotOpaqueType(StringView name, StringView cs_name,bool value, std::initializer_list<StringView> alternate_c_names) {
