...
namespace Godot
{
    ...
    public struct Vector3 : IEquatable<Vector3>
    {
        ...
        /// <summary>
        /// Returns a vector composed of the <see cref="Mathf.PosMod(float, float)"/> of this vector's components and `mod`.
        /// </summary>
        /// <param name="mod">A value representing the divisor of the operation.</param>
        /// <returns>A vector with each component <see cref="Mathf.PosMod(float, float)"/> by `mod`.</returns>
        ...
        /// <summary>
        /// Returns a vector composed of the <see cref="Mathf.PosMod(float, float)"/> of this vector's components and `modv`'s components.
        /// </summary>
        /// <param name="modv">A vector representing the divisors of the operation.</param>
        /// <returns>A vector with each component <see cref="Mathf.PosMod(float, float)"/> by `modv`'s components.</returns>
        ...
        [Obsolete("Set is deprecated. Use the Vector3(float, float, float) constructor instead.", error: true)]
