...
{
    public class DictionarySafeHandle : SafeHandle
    {
    ...
    public class Dictionary : IDictionary, IDisposable
    {
        ...
        public Dictionary(IntPtr handle)
        {
        ...
        {
            get => godot_icall_Dictionary_GetValue(GetPtr(), key.ToString());
            set => godot_icall_Dictionary_SetValue(GetPtr(), key.ToString(), value);
        }
        ...
        public void Add(object key, object value) => godot_icall_Dictionary_Add(GetPtr(), (string)key, value);
        ...
        public bool Contains(object key) => godot_icall_Dictionary_ContainsKey(GetPtr(), key.ToString());
        ...
        public void Remove(object key) => godot_icall_Dictionary_RemoveKey(GetPtr(), key.ToString());
        ...
        private class DictionaryEnumerator : IDictionaryEnumerator
        {
            ...
            {
                _dirty = false;
                Dictionary.godot_icall_Dictionary_KeyValuePairAt(_dictionary.GetPtr(), _index, out string key, out object value);
        ...
        [MethodImpl(MethodImplOptions.InternalCall)]
        internal extern static object godot_icall_Dictionary_GetValue(IntPtr ptr, string key);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal extern static object godot_icall_Dictionary_GetValue_Generic(IntPtr ptr, string key, int valTypeEncoding, IntPtr valTypeClass);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal extern static void godot_icall_Dictionary_SetValue(IntPtr ptr, string key, object value);
        ...
        [MethodImpl(MethodImplOptions.InternalCall)]
        internal extern static void godot_icall_Dictionary_KeyValuePairAt(IntPtr ptr, int index, out string key, out object value);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal extern static void godot_icall_Dictionary_KeyValuePairAt_Generic(IntPtr ptr, int index, out string key, out object value, int valueTypeEncoding, IntPtr valueTypeClass);


        [MethodImpl(MethodImplOptions.InternalCall)]
        internal extern static void godot_icall_Dictionary_Add(IntPtr ptr, string key, object value);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal extern static void godot_icall_Dictionary_Clear(IntPtr ptr);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal extern static bool godot_icall_Dictionary_Contains(IntPtr ptr, string key, object value);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal extern static bool godot_icall_Dictionary_ContainsKey(IntPtr ptr, string key);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal extern static IntPtr godot_icall_Dictionary_Duplicate(IntPtr ptr, bool deep);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal extern static bool godot_icall_Dictionary_RemoveKey(IntPtr ptr, string key);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal extern static bool godot_icall_Dictionary_Remove(IntPtr ptr, string key, object value);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal extern static bool godot_icall_Dictionary_TryGetValue(IntPtr ptr, string key, out object value);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal extern static bool godot_icall_Dictionary_TryGetValue_Generic(IntPtr ptr, string key, out object value, int valTypeEncoding, IntPtr valTypeClass);
    ...
    public class Dictionary<TKey, TValue> : IDictionary<TKey, TValue>
    {
        ...
        public Dictionary(IDictionary<TKey, TValue> dictionary)
        {
            ...
            {
                Dictionary.godot_icall_Dictionary_Add(godotDictionaryPtr, entry.Key.ToString(), entry.Value);
            }
        }
        ...
        {
            get { return (TValue)Dictionary.godot_icall_Dictionary_GetValue_Generic(_objectDict.GetPtr(), key.ToString(), valTypeEncoding, valTypeClass); }
            set { _objectDict[key.ToString()] = value; }
        }
        ...
        {
            Dictionary.godot_icall_Dictionary_KeyValuePairAt_Generic(GetPtr(), index, out string keyS, out object value, valTypeEncoding, valTypeClass);
            object key = keyS;
        ...
        {
            return _objectDict.Contains(key.ToString());
        }
        ...
        {
            return Dictionary.godot_icall_Dictionary_RemoveKey(GetPtr(), key.ToString());
        }
        ...
        {
            object retValue;
            bool found = Dictionary.godot_icall_Dictionary_TryGetValue_Generic(GetPtr(), key.ToString(), out retValue, valTypeEncoding, valTypeClass);
        ...
        {
            return _objectDict.Contains(new KeyValuePair<object, object>(item.Key.ToString(), item.Value));
        }
        ...
        {
            return Dictionary.godot_icall_Dictionary_Remove(GetPtr(), item.Key.ToString(), item.Value);
            ;
        }
