...
namespace GodotTools.Build
{
    public class BuildOutputView : VBoxContainer, ISerializationListener
    {
        ...
        {
            set => buildLog.Visibility.Visible = value;
        }
        ...
        private void IssueActivated(int idx)
        {
            ...
            {
                var script = ResourceManager.Load<Script>(file, typeHint: Internal.CSharpLanguageType);
        ...
        private void IssuesListContextOptionPressed(int incId)
        {
            IssuesContextMenuOption id = (IssuesContextMenuOption) incId; 
            switch (id)
            {
        ...
        private void IssuesListRmbSelected(int index, Vector2 atPosition)
        {
            ...
            {
                issuesListContextMenu.SetPosition(issuesList.GetGlobalRect().Position + atPosition);
        ...
        {
            base._Ready();
            SizeFlags.Vertical = (int)Control.SizeFlagsEnum.ExpandFill;
            ...
            issuesList = new ItemList
            {
                SizeFlags =
                {
                    ...
                    Vertical = (int) SizeFlagsEnum.ExpandFill
                } // Avoid being squashed by the build log
            };
            ...
            buildLog = new TextEdit
            {
                ...
                SizeFlags =
                {
                    Horizontal = (int) SizeFlagsEnum.ExpandFill,
                    Vertical = (int) SizeFlagsEnum.ExpandFill
                } // Avoid being squashed by the issues list
            };
