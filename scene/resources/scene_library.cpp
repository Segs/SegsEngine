...
void SceneLibrary::create_item(int p_item) {
...
void SceneLibrary::set_item_name(int p_item, StringView p_name) {
...
void SceneLibrary::set_item_scene(int p_item, const Ref<PackedScene> &p_mesh) {
...
void SceneLibrary::set_item_preview(int p_item, const Ref<Texture> &p_preview) {
...
const String &SceneLibrary::get_item_name(int p_item) const {
...
Ref<PackedScene> SceneLibrary::get_item_scene(int p_item) const {
...
Ref<Texture> SceneLibrary::get_item_preview(int p_item) const {
...
bool SceneLibrary::has_item(int p_item) const {
...
int SceneLibrary::find_item_by_name(StringView p_name) const {
...
int SceneLibrary::get_last_unused_item_id() const {
