...
class basic_runtime_view {
    ...
    class iterator {
        ...
        bool valid() const ENTT_NOEXCEPT {
            return eastl::all_of(from, to, [entt = *begin](const auto *view) {
    ...
    basic_runtime_view(eastl::vector<const sparse_set<Entity> *,Allocator> others) ENTT_NOEXCEPT
...
public:
    ...
    void each(Func func) const {
        eastl::for_each(begin(), end(), func);
    }

private:
    eastl::vector<const sparse_set<Entity> *,Allocator> pools;
};
