 ...
 */
template<typename Entity, typename Allocator, typename... Get, typename... Exclude>
class basic_group<Entity, Allocator, owned_t<>, get_t<Get...>, exclude_t<Exclude...>> {
 ...
 * @tparam Exclude Types of components used to filter the group.
 */
template<typename Entity, typename Allocator, typename... Owned, typename... Get, typename... Exclude>
class basic_group<Entity, Allocator, owned_t<Owned...>, get_t<Get...>, exclude_t<Exclude...>> {
    /*! @brief A registry is allowed to create groups. */
    friend class basic_registry<Entity,Allocator>;
