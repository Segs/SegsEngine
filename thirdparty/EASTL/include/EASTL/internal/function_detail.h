...
namespace eastl
{
    ...
    namespace internal
    {
        ...
        public:
            ...
            function_detail& operator=(function_detail&& other) EA_NOEXCEPT
            {
                if(this != &other)
                {
                    Destroy();
        ...
        private:
            ...
            void Move(function_detail&& other) EA_NOEXCEPT
            {
                if (other.HaveManager())
                {
        ...
        private:
            typedef void* (*ManagerFuncPtr)(void*, void*, typename Base::ManagerOperations); //EA_NOEXCEPT ?
