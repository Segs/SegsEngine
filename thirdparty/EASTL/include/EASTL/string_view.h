...
namespace eastl
{
    ...
    public:
        ...
        EA_CONSTEXPR basic_string_view(const T* s, size_type count) EA_NOEXCEPT : mpBegin(s), mnCount(count) {}
        EA_CONSTEXPR basic_string_view(const T* s) EA_NOEXCEPT : mpBegin(s), mnCount(s != nullptr ? CharStrlen(s) : 0) {}
