...
namespace eastl
{
    ...
    public:
        ...
        vector_map(this_type&& x) EA_NOEXCEPT;
        vector_map(this_type&& x, const allocator_type& allocator) EA_NOEXCEPT;
    ...
    template <typename K, typename T, typename C, typename A, typename RAC>
    inline vector_map<K, T, C, A, RAC>::vector_map(this_type&& x) EA_NOEXCEPT
    ...
    template <typename K, typename T, typename C, typename A, typename RAC>
    inline vector_map<K, T, C, A, RAC>::vector_map(this_type&& x, const allocator_type& allocator) EA_NOEXCEPT
