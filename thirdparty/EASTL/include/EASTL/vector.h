...
namespace eastl
{
	...
	public:
		VectorBase();
        VectorBase(const allocator_type& allocator) EA_NOEXCEPT;
	...
	public:
        ...
        vector(this_type&& x, const allocator_type& allocator) EA_NOEXCEPT;
	...
	template <typename T, typename Allocator>
    inline VectorBase<T, Allocator>::VectorBase(const allocator_type& allocator) EA_NOEXCEPT
		: mpBegin(NULL), 
		  mpEnd(NULL),
	...
	template <typename T, typename Allocator>
    inline vector<T, Allocator>::vector(this_type&& x, const allocator_type& allocator) EA_NOEXCEPT
		: base_type(allocator)
	{
